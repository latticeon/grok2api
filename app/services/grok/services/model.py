...
class ModelService:
    ...
    MODELS = [
        ...
        ModelInfo(
            ...
            description="Server-side ordered chat model fallback",
            is_image=False,
            is_image_edit=False,
            is_video=False,
        ),
        ModelInfo(
            model_id="grok-auto-lite",
            grok_model="grok-420",
            model_mode="MODEL_MODE_FAST",
            tier=Tier.BASIC,
            cost=Cost.LOW,
            display_name="Grok Auto Lite",
            description="Server-side ordered lite chat model fallback",
            is_image=False,
            is_image_edit=False,
            is_video=False,
        ),
